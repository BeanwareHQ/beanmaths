...
public class Colors {
    ...
    public static Color BLANK = new Color(0, 0, 0, 0); // Blank (Transparent)
    public static Color MAGENTA = new Color(255, 0, 255, 255); // Magenta
    public static Color RAYWHITE = new Color(245, 245, 245, 255); // My own White (raylib logo)

    public static Color withOpacity(Color color, int opacity) {
        return new Color((int) color.r(), (int) color.g(), (int) color.b(), opacity);
    }
}
